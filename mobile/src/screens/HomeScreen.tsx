...
export const HomeScreen: React.FC = () => {
	...
	const quickActions = [
		{ icon: 'calendar-outline', label: 'Book Now', color: colors.primary },
		{ icon: 'card-outline', label: 'Payments', color: colors.primary },
		{ icon: 'call-outline', label: 'Contact', color: colors.primary },
		{ icon: 'fitness-outline', label: 'Workouts', color: colors.primary },
		{ icon: 'calendar-outline', label: 'Scheduling', color: colors.primary },
	];
			...
			<ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
				...
				<View style={styles.servicesGrid}>
					{quickActions.map((action, index) => (
						...
						>
							<View style={[styles.serviceIcon, { backgroundColor: `${action.color}20` }]}>
